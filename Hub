--RELOAD GUI
if game.CoreGui:FindFirstChild("Beto hub") then
...
--LOAD GUI
task.wait(0.1)
local Beto hub = Instance.new("ScreenGui")
...
Beto hub.Name = "Beto hub"
Beto hub.Parent = game.CoreGui
Beto hub.ZIndexBehavior = Enum.ZIndexBehavior.Sibling

Background.Name = "Background"
Background.Parent = Beto hub
