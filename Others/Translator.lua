...
properties.Text = "[TR] To send messages in a language, say > followed by the target language/language code, ex: >ru or >russian. To disable (go back to original language), say >d."
