...
for _, v in pairs(game.Players:GetPlayers()) do
    ...
    local function ESP()
        ...
        connection =
            ...
            function()
                if
                    on and v.Character and v.Character:FindFirstChild("Humanoid") and
    ...
    function(newplr)
        ...
        local function ESP()
            ...
            connection =
                ...
                function()
                    if
                        on and newplr.Character and newplr.Character:FindFirstChild("Humanoid") and
...
local function esppc()
    while Pc do
        for _, v in pairs(game.Workspace:GetDescendants()) do
            if v.Name == "ComputerTable" and not v:FindFirstChild("PCHighlight") then
...
local function espv()
    while c do
        for _, v in pairs(game.workspace:GetDescendants()) do
            if v.Name == "Vent" or v.Name == "VentBlock" and not v.FindFirstChild("VentH") then
...
Tabs.Misc:AddButton(
    {
        ...
        Callback = function()
            loadstring(
                game:HttpGet("https://raw.githubusercontent.com/JosejamesDev/Beto-hub/main/Others/Translator.lua")
            )()
        end
    }
)
