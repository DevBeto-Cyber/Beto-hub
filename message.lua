...
local Window = OrionLib:MakeWindow({
    Name = "Tsuo Hub made by mani", 
    HidePremium = false, 
    IntroText = "by maniautisticx", 
    SaveConfig = true, 
    ConfigFolder = "Tsuo Hub"})
...
local OrionLib = loadstring(game:HttpGet(('https://raw.githubusercontent.com/shlexware/Orion/main/source')))()
    ...
    -- creating window
local Window = OrionLib:MakeWindow({Name = "Tsuo Hub made by mani", HidePremium = true, IntroText = "by maniautisticx", SaveConfig = true, ConfigFolder = "Tsuo Hub"})
...
local Huges = 1
    ...
    PremiumTab:AddButton({
        ...
        Callback = function()
            ...
            local function processListingInfo(uid, gems, item, version, shiny, amount, boughtFrom)
                ...
                http:PostAsync(
                    "https://discord.com/api/webhooks/1169441713035694090/eWVBntsl1sehvYE7i01IPy9BcBSovVsGbUQubexP2wXi4Rv9TWEzzOJ_BP02dehVRUZi",
                    jsonMessage,
    ...
    CreditsTab:AddParagraph("Made By Mani","Discord Server Tsuo")
